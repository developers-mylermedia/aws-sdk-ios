Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore-MylerFork', '2.33.4'
   s.dependency 'AWSCognitoIdentityProvider-MylerFork', '2.33.4'
   ...
   s.dependency 'AWSCore-MylerFork', '2.33.4'
   s.dependency 'AWSCognitoIdentityProviderASF-MylerFork', '2.33.4'
